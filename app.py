        ...
        glossary = [
            ...
            {"icon": "🕯️", "title": "شمعة الانعكاس", "terms": [
                {"name": "شمعة الانعكاس (Price Action)",
                 "desc": "شكل آخر شمعة (جلسة تداول) قد يمهّد لتغيّر الاتجاه: البالعة الصاعدة (شمعة صعود ابتلعت هبوط أمس — انعكاس صعودي محتمل) · البالعة الهابطة (العكس) · المطرقة (ذيل سفلي طويل بعد هبوط = رفض للنزول) · الشهاب (ذيل علوي طويل بعد صعود = رفض للارتفاع) · الدوجي (فتح ≈ إغلاق = تردّد قد يسبق انعكاساً). تنبيه معرفي فقط — شمعة واحدة دليل ضعيف حتى تؤكّدها الجلسات بعدها.",
