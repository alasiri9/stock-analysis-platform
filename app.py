        ...
        glossary = [
            ...
            {"icon": "⏱️", "title": "الفريمات الثلاثة", "terms": [
                {"name": "تأكيد الفريمات (يومي · أسبوعي · شهري)",
                 "desc": "حالة السهم على ثلاثة أُطر زمنية معاً، محسوبة من أسعاره نفسها (بلا تكلفة). اتجاه كل فريم يُقرأ بتتابع القمم والقيعان (نفس منطق هيكل السوق) لا بالمتوسطات المتأخرة. الفكرة أن الاتجاه الأقوى هو ما اتّفقت عليه الفريمات: 🟢 إيجابي (صاعد) · 🔴 سلبي (هابط) · ⚪ محايد.",
                ...
                {"name": "كيف يُقاس اتجاه كل فريم؟",
                 "desc": "بالقمم والقيعان المتتابعة (HH/HL صعوداً · LH/LL هبوطاً) — الطريقة الصحيحة لقراءة الاتجاه (داو/سمارت موني)، لا بالمتوسطات المتأخرة. الأسبوعي والشهري نبنيهما بتجميع أسعار خمس سنوات كاملة، فتكفي شموعهما للقمم والقيعان. وصفي تعليمي — لا توصية.",
                 "example": None},
            ]},
