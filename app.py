        ...
        glossary = [
            ...
            {"icon": "👑", "title": "مؤشر Algomatix", "terms": [
                {"name": "الدرجة الموزونة (0–100)", "id": "algomatix",
                 "desc": "الدرجة الشاملة لكل سهم، تجمع 8 مدارس موزونة بأهميتها: هيكل السوق · الجودة والنمو · الاتجاه · الزخم · السيولة · المستويات · القوة النسبية · الشموع. الأعلى = فرصة أقوى للدراسة. 🟢 قوية (70+) 🟡 جيدة (55–69) ⚪ محايد (40–54) 🔴 ضعيف. هي المقياس الأشمل لأنها تضيف الأساسيات المالية وتوزن كل مدرسة بأهميتها — بخلاف «مجموع نقاط الاستراتيجيات» الفني البحت.",
