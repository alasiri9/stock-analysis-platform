        ...
        glossary = [
            ...
            {"icon": "👑", "title": "مؤشر Algomatix", "terms": [
                {"name": "الدرجة الموزونة (0–100)", "id": "algomatix",
                 "desc": "مبني على 8 مدارس تحليلية مجموع أوزانها 100 (هيكل السوق · الجودة والنمو · الاتجاه · الزخم · السيولة · المستويات · القوة النسبية · الشموع)، تجمع 16 معياراً ما بين الفني والمالي في درجة موحّدة (0–100) تلخّص قوّة كل سهم برقم واحد. 🟢 قوية (70+) 🟡 جيدة (55–69) ⚪ محايد (40–54) 🔴 ضعيف. هو المقياس الأشمل لأنه يضيف الأساسيات المالية ويوزن كل مدرسة بأهميتها — بخلاف «مجموع نقاط الاستراتيجيات» الفني البحت.",
                 "example": "درجة 81 = تضافر قوي عبر المدارس الثماني معاً."},
            ]},
